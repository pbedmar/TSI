...
public class AgenteDFS_stack extends AbstractPlayer {
    ...
    public AgenteDFS_stack(StateObservation so, ElapsedCpuTimer elapsedTimer) {
    ...
    public Types.ACTIONS act(StateObservation so, ElapsedCpuTimer elapsedTimer) {
        ...
        if (!route_computed) {
            ...
            while (!queue.isEmpty() && !route_computed) {
                Vector2dInt expanded_node = queue.removeLast();
